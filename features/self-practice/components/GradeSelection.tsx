...
import type { SelfPracticeSubject, TestGrade } from '../../../types/index';
  ...
  return (
    <div className="container mx-auto max-w-4xl">
      ...
      <div className="text-center mb-10">
        <h1 className="text-3xl font-bold text-slate-800">Chọn khối lớp môn {subject.name}</h1>
        <p className="text-slate-500 mt-2">Tìm các bài luyện tập phù hợp với chương trình học của bạn.</p>
      </div>
