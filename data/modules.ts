...
export const MODULES: Module[] = [
  ...
  { id: 3, title: 'Kiểm tra', description: 'Tập hợp đề thi, kiểm tra của các trường trên toàn tỉnh Tuyên Quang.', icon: ClockIcon, color: 'bg-orange-500', tags: ['15 Phút', '1 Tiết', 'Học Kỳ'] },
